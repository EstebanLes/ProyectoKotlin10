package com.example.proyectokotlin10
...
class MainActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    override fun onInit(status: Int) {
       if (status==TextToSpeech.SUCCESS){
           findViewById<TextView>(R.id.tvStatus).text = getString(R.string.tts_listo)
           tts!!.setLanguage(Locale("ES"))
       }else{
           findViewById<TextView>(R.id.tvStatus).text = getString(R.string.tts_noDisponible)
       }
    }
